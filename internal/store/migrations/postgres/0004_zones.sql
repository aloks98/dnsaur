...
CREATE TABLE zones (
  ...
  soa_refresh BIGINT NOT NULL DEFAULT 900,
  soa_retry BIGINT NOT NULL DEFAULT 300,
  soa_expire BIGINT NOT NULL DEFAULT 604800,
...
CREATE TABLE zone_records (
  ...
  name TEXT NOT NULL,
  type TEXT NOT NULL,
  ttl BIGINT NOT NULL DEFAULT 3600,
