...
// is the one extra accepted — handleSettingsPut strips it before the value is
// stored, and confsync.ParsePeerURL, which grades the same value on the
// Follow path, accepts and strips it too (TestPeerURLGrammarsAgree).
