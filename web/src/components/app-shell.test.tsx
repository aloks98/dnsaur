...
// Being a replica — plaintext peer included — is a state, not a fault: the
// strip is kept for the two facts that are actually wrong, and everything
// else about following a main reads as the top bar's chip and, on the Sync
// band, the line beside the peer URL itself.
test("a peer reached over plain http gets the role chip and no shell banner", async () => {
  mockResolverStatus({
    serving: OFF_SERVING,
